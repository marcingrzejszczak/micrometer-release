...
class ChangelogProcessorTests {
    ...
    File expectedOutput = new File(
        ChangelogProcessorTests.class.getResource("/processor/output.md").toURI());

    static List<String> expectedGradleCommand = List.of("./gradlew",
        "concurrency-tests:dependencies", "docs:dependencies",
        "micrometer-benchmarks-core:dependencies", "micrometer-bom:dependencies",
        "micrometer-commons:dependencies",
        "micrometer-core:dependencies", "micrometer-jakarta9:dependencies",
        "micrometer-java11:dependencies",
        "micrometer-jetty11:dependencies", "micrometer-jetty12:dependencies",
        "micrometer-observation:dependencies",
        ...
        "micrometer-registry-azure-monitor:dependencies",
        "micrometer-registry-cloudwatch2:dependencies",
        ...
        "micrometer-registry-prometheus-simpleclient:dependencies",
        "micrometer-registry-signalfx:dependencies",
        ...
        "micrometer-samples-kotlin:dependencies",
        "micrometer-samples-spring-integration:dependencies",
    ...
    static ChangelogProcessor testChangelogProcessor(File output) {
        return new ChangelogProcessor(output) {
            ...
            InputStream dependenciesInputStream(List<String> gradleCommand) throws Exception {
                ...
                URL resource = ChangelogGeneratorTests.class.getResource(
                    "/gradle/dependencies_output.txt");
    ...
    void should_parse_single_changelog() throws Exception {
        ...
        then(Files.readString(output.toPath())).isEqualToIgnoringNewLines(
            Files.readString(expectedOutput.toPath()));
    }
