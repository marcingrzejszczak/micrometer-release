...
class ProjectTrainMavenCentralSyncChecker {

    private static final Logger log = LoggerFactory.getLogger(ProjectTrainMavenCentralSyncChecker.class);
    ...
    ProjectTrainMavenCentralSyncChecker(String artifactToCheck) {
