...
class ProjectTrainReleaseScheduler {

    private static final Logger log = LoggerFactory.getLogger(ProjectTrainReleaseScheduler.class);

    private final ProjectTrainCircleCiChecker circleCiChecker;

    private final ProcessRunner processRunner;

    ProjectTrainReleaseScheduler(ProjectTrainCircleCiChecker circleCiChecker, ProcessRunner processRunner) {
    ...
    private void createGithubRelease(String version, String branch) throws IOException, InterruptedException {
        ...
        processRunner.startProcess("gh", "release", "create", "v" + version, "--target", branch, "-t", version);
    }
