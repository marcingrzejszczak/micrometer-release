...
class ProjectTrainVersionToBranchConverter {

    private static final Logger log = LoggerFactory.getLogger(ProjectTrainVersionToBranchConverter.class);
    ...
    ProjectTrainVersionToBranchConverter(String githubToken, String githubApiBranchUrl, HttpClient httpClient) {
